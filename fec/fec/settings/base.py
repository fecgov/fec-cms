...
CRONJOBS = [
    ...
    ('*/3 * * * *', 'django.core.management.call_command', ['scrape_transition_pages'], {}, ('> ' + os.path.join(BASE_DIR,'transitionfile.log'))),
    ('*/5 * * * *', 'django.core.management.call_command', ['scrape_web_app_pages'], {}, ('> ' + os.path.join(BASE_DIR,'web_appfile.log'))),
]
