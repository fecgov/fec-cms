...
class AddSecureHeaders(MiddlewareMixin):
    ...
    def process_response(self, request, response):
        ...
        content_security_policy = {
            ...
            "img-src": "'self' *.fec.gov *.app.cloud.gov data: https://*.ssl.fastly.net https://www.google-analytics.com https://www.googletagmanager.com https://www.gravatar.com/avatar/dd9a1a05d5c70a0ce8317f4172745459?s=100&d=mm",
