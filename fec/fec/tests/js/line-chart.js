...
describe('LineChart', function() {
  ...
  it('sets the x-scale domain to the correct dates and width', function() {
    ...
    const maxDate = new Date('01/01/2017');
  ...
  it('sets the y-scale to the correct domain and range', function() {
    const y = this.lineChart.setYScale();
  ...
  // helpers.isMediumScreen is non-configurable and non-writable
  /* 
  describe('xAxisFormatter() for small screens', function() {
    before(function() {
      sinon.stub(helpers, 'isMediumScreen').callsFake(function() { return false; });
    ...
    it('parses month and year on january', function() {
      const date = new Date('01/01/2015');
    ...
    it('parses month for May but not July', function() {
      ...
      const may = new Date('05/01/2015');
      const july = new Date('07/01/2015');
  ...
  describe('xAxisFormatter() for medium and up screens', function() {
    before(function() {
      sinon.stub(helpers, 'isMediumScreen').callsFake(function() { return true; });
      this.formatter = this.lineChart.xAxisFormatter();
    });
    ...
    it('parses month for May but not April', function() {
      ...
      const may = new Date('05/01/2015');
      const april = new Date('04/01/2015');
      expect(this.formatter(may)).to.equal('May');
  ...
  describe('moveCursor()', function() {
    ...
    // TODO: sinon - come back to this
    // expected 45.22571819425445 to be above 70
    /*
    it('positions the cursor line', function() {
      // Get the x-coordinate from the x axis
      const xCoordinate = this.lineChart.x(this.datum.date);
  ...
  // TODO: sinon - is this because of moving from CommonJS to modules?
  // TypeError: Attempted to wrap undefined property zeroPad as function
  /*
