...
// Because there are so many non-camel var names, let's ignore that rule for this file
// jshint camelcase: false

/**
 * @fileOverview Handles the automated testing for {@link /fec/fec/static/js/modules/line-chart.js}
 * @todo Re-enable this test after we migrate to an ES6 testing package
 *
 * @author       fec.gov
 *
 * @see {@link /fec/fec/static/js/modules/line-chart.js}
 * 
 * @requires      chai
 * @requires      sinon
 * @requires      sinon-chai
...
//     expect(Object.keys(entityTotals)).to.deep.equal([
//       'candidate',
//       'party',
//       'pac'
//     ]);
...
//     before(function() {
//       sinon.stub(helpers, 'isMediumScreen', function() {
//         return false;
//       });
...
//       expect(this.lineChart.prevDatum).to.deep.equal(
//         this.lineChart.chartData[0]
//       );
...
//       expect(this.lineChart.$snapshot.find('.js-max-date').html()).to.equal(
//         '01/31/2015'
//       );
//     });
...
//       var total = this.lineChart.$snapshot
//         .find('[data-total-for="all"]')
//         .html();
