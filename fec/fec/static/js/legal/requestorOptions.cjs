module.exports = [
  ...
  {
    value: '9',
    text: 'Membership Organization, Cooperative, Corporation W/O Capital Stock'
  },
  {
    value: '10',
    text: 'Corporation (including LLCs electing corporate status)'
  },
  {
    value: '11',
    text: 'Partnership (including LLCs electing partnership status)'
  },
