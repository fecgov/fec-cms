(function($) {
  ...
  $.htmlClean = function(html, options) {
    ...
    return $.htmlClean.trim(render(root, options).join('')); // TODO: remove jQuery.trim as it's been deprecated
  };
  $.htmlClean.defaults = {
    bodyOnly: true,
    allowedTags: [],
        ...
        if (element.tag.isNonClosing) {
          ...
          if (element.tag.toProtect) {
            outputChildren = $.htmlClean
              .trim(element.children.join('')) // TODO: remove jQuery.trim as it's been deprecated
              .replace(/<br>/gi, '\n');
            ...
            for (var i = 0; i < element.children.length; i++) {
              ...
              var text = $.htmlClean.trim( // TODO: remove jQuery.trim as it's been deprecated
  ...
  $.htmlClean.trim = function(text) { // TODO: remove jQuery.trim as it's been deprecated
