...
class Command(BaseCommand):
    help = 'Takes a JSON list of web app pages and scrapes content from \
        the live site. Saves JSON for indexing on DigitalGov Search'

    def add_arguments(self, parser):
        parser.add_argument(
            '--json_file_path', type=str, help='Path to JSON file to load'
        )
    ...
    def handle(self, *args, **options):
        ...
        if options['json_file_path']:
            ...
            file_name = os.path.join(
                settings.REPO_DIR, 'fec/search/management/data/web_app_pages.json'
            )
            ...
            Read a JSON file with data structured like:
              {
                ...
                "language": "en",
                "promote": "true",
                "description": "See how candidates and committees raise and spend \
                    money in federal elections. This financial data helps voters \
                    make informed decisions.",
                "tags": "data, finance data, contributions, candidates, committees, \
                 pacs, super pacs, disclosure",
                "content": "",
                "scrape_content": ""
              },
            """
