...
class MockPage(object):
    ...
    def __init__(
        ...
        add_latest_revision=False,
        parent_path='/home/about/',
        ancestor_path='/home/',
    ):
...
@override_settings(
    FEC_CMS_ENVIRONMENT='PRODUCTION', CANONICAL_BASE='https://www.fec.gov'
)
...
class TestSearchIndexing(TestCase):
    ...
    def test_add_document(self, scrape, m):
        ...
        m.register_uri(
            'POST', '{}/documents'.format(DIGITALGOV_BASE_URL), status_code=201
        )
    ...
    def test_add_existing_document(self, update_document, scrape, m):
        ...
        m.register_uri(
            'POST', '{}/documents'.format(DIGITALGOV_BASE_URL), status_code=422
        )
        search.add_document(self.page)
    ...
    def test_update_document(self, scrape, m):
        ...
        m.register_uri(
            'PUT', '{}/documents/123'.format(DIGITALGOV_BASE_URL), status_code=200
        )
    ...
    def test_delete_document_in_prod(self, scrape, m):
        ...
        m.register_uri(
            'DELETE', '{}/documents/123'.format(DIGITALGOV_BASE_URL), status_code=200
        )
    ...
    def test_check_ancestors_valid_ancestors(self, scrape):
        ...
        page = MockPage(
            parent_path='/home/legal-resources/something/',
