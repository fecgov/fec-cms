...
def disbursements(request):
    if len(request.GET) == 0:
        return redirect(
            '/data/disbursements/?two_year_transaction_period='
            + str(constants.DEFAULT_ELECTION_YEAR)
            + '&min_date='
            + '01/01/'
            + str(constants.DEFAULT_ELECTION_YEAR - 1)
            + '&max_date='
            + '12/31/'
            + str(constants.DEFAULT_ELECTION_YEAR)
        )
...
def individual_contributions(request):
    if len(request.GET) == 0:
        return redirect(
            '/data/receipts/individual-contributions/?two_year_transaction_period='
            + str(constants.DEFAULT_ELECTION_YEAR)
            + '&min_date='
            + '01/01/'
            + str(constants.DEFAULT_ELECTION_YEAR - 1)
...
def receipts(request):
    if len(request.GET) == 0:
        return redirect(
            '/data/receipts/?two_year_transaction_period='
            + str(constants.DEFAULT_ELECTION_YEAR)
            + '&min_date='
            + '01/01/'
            + str(constants.DEFAULT_ELECTION_YEAR - 1)
