...
urlpatterns = [
    ...
    url(
        r'^data/committee/(?P<committee_id>\w+)/$',
        views.committee,
        name='committee-by-id',
    ),
    url(
        r'^data/elections/(?P<office>\w+)/(?P<state>\w+)/(?P<district>\w+)/(?P<cycle>[0-9]+)/$',
        views.elections,
        name='elections-house',
    ),
    url(
        r'^data/elections/(?P<office>\w+)/(?P<state>\w+)/(?P<cycle>[0-9]+)/$',
        views.elections,
        name='elections-senate',
    ),
    url(
        r'^data/elections/(?P<office>\w+)/(?P<cycle>[0-9]+)/$',
        views.elections,
        name='elections-president',
    ),
    ...
    # Datatables
    url(r'^data/candidates/(?P<office>\w+)/$', views_datatables.candidates_office),
    url(r'^data/candidates/$', views_datatables.candidates),
    url(r'^data/committees/$', views_datatables.committees),
    url(r'^data/communication-costs/$', views_datatables.communication_costs),
    url(r'^data/disbursements/$', views_datatables.disbursements),
    url(
        r'^data/electioneering-communications/$',
        views_datatables.electioneering_communications,
    ),
    url(r'^data/filings/$', views_datatables.filings),
    url(r'^data/independent-expenditures/$', views_datatables.independent_expenditures),
    url(r'^data/individual-contributions/$', views_datatables.individual_contributions),
    url(r'^data/loans/$', views_datatables.loans),
    url(
        r'^data/party-coordinated-expenditures/$',
        views_datatables.party_coordinated_expenditures,
    ),
    url(
        r'^data/receipts/individual-contributions/$',
