...
report_type_full = OrderedDict([
    ...
    ('12CAU', 'Pre-Caucus'),
    ('12G', 'Pre-General'),
    ('12GR', 'Pre-General Run-Off'),
    ('12P', 'Pre-Primary'),
    ('12PR', 'Pre-Primary Run-Off'),
    ('12R', 'Pre-Run-Off'),
    ('12S', 'Pre-Special'),
    ('12SC', 'Pre-Special Convention'),
    ('12SG', 'Pre-Special General'),
    ('12SGR', 'Pre-Special General Run-Off'),
    ('12SP', 'Pre-Special Primary'),
    ('12SPR', 'Pre-Special Primary Run-Off'),
    ('30D', 'Post-Election'),
    ('30G', 'Post-General'),
    ('30GR', 'Post-General Run-Off'),
    ('30P', 'Post-Primary'),
    ('30R', 'Post-Run-Off'),
    ('30S', 'Post-Special'),
    ('30SC', 'Post-Special Convention'),
    ('30SG', 'Post-Special General'),
    ('30SGR', 'Post-Special General Run-Off'),
    ('60D', 'Post-Convention'),
    ('Q1', 'April Quarterly'),
    ('Q2', 'July Quarterly'),
    ('Q3', 'October Quarterly'),
