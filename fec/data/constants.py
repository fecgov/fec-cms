...
DISTRICT_MAP_CUTOFF = 2012  # The year we show district maps for on election pages. Change at the beginning of the year
...
countries = OrderedDict([
    ...
    ('KEN', 'Kenya'),
    ('KIR', 'Kiribati'),
    ('PRK', 'Korea (Democratic Peopleʼs Republic of)'),
    ('KOR', 'Korea (Republic of)'),
    ('KWT', 'Kuwait'),
    ('KGZ', 'Kyrgyzstan'),
    ('LAO', 'Lao Peopleʼs Democratic Republic'),
    ('LVA', 'Latvia'),
    ('LBN', 'Lebanon'),
    ('LSO', 'Lesotho'),
    ('LBR', 'Liberia'),
