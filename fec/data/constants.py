...
contributor_states = OrderedDict(
    sorted(
        utils.extend(
            states,
            {
...
parties = OrderedDict([('DEM', 'Democratic Party'), ('REP', 'Republican Party'), ])
...
quarterly_reports = OrderedDict(
    [('Q1', 'April quarterly'), ('Q2', 'July quarterly'), ('Q3', 'October quarterly'), ]
)

semiannual_reports = OrderedDict([('MY', 'Mid-year report'), ])
...
form_types = OrderedDict(
    [
        ...
        (
            'F5',
            "Independent expenditure reports and notices \
                (by a person or group) (Form 5)",
        ),
        (
            'F24',
            "Independent expenditure reports and notices \
            (by a registered committee) (Form 24)",
        ),
...
candidate_status = OrderedDict([('C', 'Statutory candidate'), ])
...
pac_party = OrderedDict([('PAC', 'PACs'), ('PAR', 'Political Party Committees'), ])
...
house_senate_types = OrderedDict([('H', 'House'), ('S', 'Senate')])
...
audit_primary_categories_options = [
    {"primary_category_id": 'all', "primary_category_name": 'All'},
    {"primary_category_id": '2', "primary_category_name": 'Allocation Issues'},
    {"primary_category_id": '3', "primary_category_name": 'Disclosure'},
    {"primary_category_id": '5', "primary_category_name": 'Excessive Contributions'},
    {
        "primary_category_id": '1',
        "primary_category_name": 'Failure to File Reports/Schedules/Notices',
    },
    {"primary_category_id": '8', "primary_category_name": 'Loans'},
    {
    ...
    {"primary_category_id": '9', "primary_category_name": 'Other'},
    {"primary_category_id": '15', "primary_category_name": 'Payments/Disgorgements'},
    {"primary_category_id": '6', "primary_category_name": 'Prohibited Contributions'},
    {"primary_category_id": '4', "primary_category_name": 'Recordkeeping'},
    {
        "primary_category_id": '17',
        "primary_category_name": 'Referred Findings Not Listed',
    },
    {"primary_category_id": '13', "primary_category_name": 'Repayment to US Treasury'},
]

audit_sub_categories_options = [{"sub_category_id": 'all', "sub_category_name": ' '}]
...
table_columns = OrderedDict(
    [
        ...
        (
            'candidates-office-senate',
            ['Name', 'Party', 'State', 'Receipts', 'Disbursements'],
        ),
        (
            'candidates-office-house',
            ['Name', 'Party', 'State', 'District', 'Receipts', 'Disbursements'],
        ),
        (
            'committees',
            [
        ...
        (
            'communication-costs',
            ['Committee', 'Support/Oppose', 'Candidate', 'Amount', 'Date'],
        ),
        (
            'disbursements',
            [
        ...
        (
            ...
            ['Spender', 'Candidate', 'Payee name', 'Expenditure date', 'Amount'],
        ),
        (
            'receipts',
            [
    ...
    'receipts': {
        ...
        'presidential': OrderedDict(
            [
                ...
                (
                    'F3P-20B',
                    'Offsets to operating expenditures - fundraising (Line 20b)',
                ),
                (
                    'F3P-20C',
                    'Offsets to operating expenditures - legal and accounting (Line 20c)',
                ),
        ...
        'pac_party': OrderedDict(
            [
                ...
                (
                    'F3X-16',
                    'Refunds of contributions made to federal candidates and other political committees (Line 16)',
                ),
...
RAISING_FORMATTER = OrderedDict(
    [
        ...
        ('federal_funds', {'label': 'Presidential public funds', 'level': '3'}),  # F3P
        (
        ...
        (
            'loans_made_by_candidate',  # F3
            {
                'label': 'Loans made by candidate',
                'level': '3',
                'type': {'link': 'receipts', 'H': 'F3-13A', 'S': 'F3-13A'},
            },
        ),
        (
        ...
        (
            'all_other_loans',  # F3
            {
                'label': 'Other loans',
                'level': '3',
                'type': {'link': 'receipts', 'H': 'F3-13B', 'S': 'F3-13B'},
            },
        ),
        (
        ...
        (
            'offsets_to_operating_expenditures',  # F3, F3X
            {
                'label': 'Offsets to operating expenditures',
                'level': '2',
                'type': {'link': 'receipts', 'H': 'F3-14', 'S': 'F3-14', 'O': 'F3X-15'},
            },
        ),
        (
            'offsets_to_fundraising_expenditures',  # F3P
            {
                'label': 'Fundraising offsets',
                'level': '3',
                'type': {'link': 'receipts', 'P': 'F3P-20B'},
            },
        ),
        (
            'offsets_to_legal_accounting',  # F3P
            {
                'label': 'Legal and accounting offsets',
                'level': '3',
                'type': {'link': 'receipts', 'P': 'F3P-20C'},
            },
        ),
        (
            'other_receipts',  # F3, F3P
            {
                ...
                'level': '2',
                'type': {'link': 'receipts', 'P': 'F3P-21', 'H': 'F3-15', 'S': 'F3-15'},
            },
        ),
        (
            'fed_candidate_contribution_refunds',  # F3X
            {
                'label': 'Candidate refunds',
                'level': '2',
                'type': {'link': 'receipts', 'O': 'F3X-16'},
            },
        ),
        (
...
SPENDING_FORMATTER = OrderedDict(
    [
        ...
        (
            ...
            {'label': 'Allocated operating expenditures - non-federal', 'level': '3'},
        ),
        (
        ...
        (
            'fundraising_disbursements',  # F3P
            {
                'label': 'Fundraising',
                'level': '2',
                'type': {'link': 'disbursements', 'P': 'F3P-25'},
            },
        ),
        (
            'exempt_legal_accounting_disbursement',  # F3P
            {
                'label': 'Exempt legal and accounting',
                'level': '2',
                'type': {'link': 'disbursements', 'P': 'F3P-26'},
            },
        ),
        (
            'transfers_to_affiliated_committee',  # F3X
            {
                ...
                'level': '2',
                'type': {'link': 'disbursements', 'O': 'F3X-22'},
            },
        ),
        (
            'fed_candidate_committee_contributions',  # F3X
            {
                'label': 'Contributions to other committees',
                'level': '2',
                'type': {'link': 'disbursements', 'O': 'F3X-23'},
            },
        ),
        (
        ...
        (
            ...
            {
                'label': 'Party coordinated expenditures',
                'level': '2',
        ...
        (
            'loans_made',  # F3X
            {
                'label': 'Loans made',
                'level': '2',
                'type': {'link': 'disbursements', 'O': 'F3X-27'},
            },
        ),
        (
            'loan_repayments_made',  # F3X
            {
                ...
                'level': '2',
                'type': {'link': 'disbursements', 'O': 'F3X-26'},
            },
        ),
        (
        ...
        (
            'repayments_loans_made_by_candidate',  # F3P
            {
                ...
                'level': '3',
                'type': {'link': 'disbursements', 'P': 'F3P-27A'},
            },
        ),
        (
            'repayments_other_loans',  # F3P
            {
                ...
                'level': '3',
                'type': {'link': 'disbursements', 'P': 'F3P-27B'},
            },
        ),
        (
        ...
        (
            'loan_repayments_candidate_loans',  # F3
            {
                'label': 'Candidate loan repayments',
                'level': '3',
                'type': {'link': 'disbursements', 'H': 'F3-19A', 'S': 'F3-19A'},
            },
        ),
        (
            'loan_repayments_other_loans',  # F3
            {
                'label': 'Other loan repayments',
                'level': '3',
                'type': {'link': 'disbursements', 'H': 'F3-19B', 'S': 'F3-19B'},
            },
        ),
        (
...
HOST_RAISING_FORMATTER = OrderedDict(
    [
        ...
        ('federal_funds', {'label': 'Federal funds', 'level': '2'}),  # Line 13
        (
        ...
        ('all_loans_received', {'label': 'Loans Received', 'level': '3'}),  # Line 16a
        (
        ...
        (
            ...
            {
                'label': 'Refunds, Rebates, Returns of Deposits Relating to Convention Expenditures',
                'level': '2',
            },
        ),
        (
            ...
            {
                'label': ' Itemized Refunds, Rebates, Returns of Deposits Relating to Convention',
                'level': '3',
            },
        ),
        (
            ...
            {
                'label': 'Unitemized Refunds, Rebates, Returns of Deposits Relating to Convention',
                'level': '3',
            },
        ),
        (
        ...
        ('other_fed_receipts', {'label': ' Other Income', 'level': '2'}),  # Line 19
        (
...
HOST_SPENDING_FORMATTER = OrderedDict(
    [
        ...
        (
            ...
            {'label': 'Convention Expenditures', 'level': '2'},
        ),
        (
            'itemized_convention_exp',  # Line 21a
            {'label': 'Itemized Convention Expenditures', 'level': '3'},
        ),
        (
            'unitemized_convention_exp',  # Line 21a
            {'label': 'Unitemized Convention Expenditures', 'level': '3'},
        ),
        (
            'transfers_to_affiliated_committee',  # Line 22
            {'label': 'Transfers to Affiliated Committees', 'level': '2'},
        ),
        (
            'loans_and_loan_repayments_made',  # Line 23
            {'label': 'Loans and Loan Repayments Made', 'level': '2'},
        ),
        ('loans_made', {'label': 'Loans Made', 'level': '3'}),  # Line 23a
        (
            'loan_repayments_made',  # Line 23a
            {'label': 'Loan Repayments Made', 'level': '3'},
        ),
        (
            'other_disbursements',  # Line 24
            {'label': 'Other Disbursements', 'level': '2'},
        ),
        (
            'itemized_other_disb',  # Line 24a
            {'label': 'Itemized Other Disbursements', 'level': '3'},
        ),
        (
            'unitemized_other_disb',  # Line 24a
            {'label': 'Unitemized Other Disbursements', 'level': '3'},
        ),
    ]
)
...
CASH_FORMATTER = OrderedDict(
    [
        (
            ...
            {'label': 'Beginning cash on hand', 'level': '2'},
        ),  # F3, F3P, #F3X
        (
        ...
        (
            ...
            {'label': 'Debts/loans owed to committee', 'level': '2'},
        ),  # F3, F3P, F3X
        (
            'last_debts_owed_by_committee',
            {'label': 'Debts/loans owed by committee', 'level': '2'},
        ),  # F3, F3P, F3X

        # Commenting out net numbers because the underlying logic is incorrect
        # ('net_contributions', {'label': 'Net contributions', 'level': '2'}),
        # F3, F3X
        # ('contributions', {'label': 'Total contributions', 'level': '3'}),
        # F3, #F3P, F3X
        # ('contribution_refunds', {'label': '(Total contribution refunds)', 'level': '3'}),
        # F3, F3P, F3X
        # ('net_operating_expenditures', {'label': 'Net operating expenditures', 'level': '2'}),
        # F3, F3X
        # ('operating_expenditures', {'label': 'Operating expenditures', 'level': '3'}),
        # F3, F3P, F3X
        # ('offsets_to_operating_expenditures', {'label': '(Offsets to operating expenditures)', 'level': '3'}),
        # F3, F3P, F3X
        # ('subtotal_offsets_to_operating_expenditures', {'label': 'Offsets to operating expenditures', 'level': '3'}),
        # F3P
...
IE_FORMATTER = OrderedDict(
    [
        (
            ...
            {'label': 'Contributions received', 'level': '1'},
        ),
        (
            'total_independent_expenditures',
            {'label': 'Independent expenditures', 'level': '1'},
        ),
    ]
)
...
SENATE_CLASSES = {
    '1': ['AZ', 'CA', 'CT', 'DE', 'FL', 'HI', 'IN', 'ME', 'MD', 'MA', 'MI', 'MN', 'MS', 'MO', 'MT', 'NE', 'NV', 'NJ', 'NM', 'NY', 'ND', 'OH', 'PA', 'RI', 'TN', 'TX', 'UT', 'VT', 'VA', 'WA', 'WV', 'WI', 'WY'],  # noqa
    '2': ['AL', 'AK', 'AR', 'CO', 'DE', 'GA', 'ID', 'IL', 'IA', 'KS', 'KY', 'LA', 'ME', 'MA', 'MI', 'MN', 'MS', 'MT', 'NE', 'NH', 'NJ', 'NM', 'NC', 'OK', 'OR', 'RI', 'SC', 'SD', 'TN', 'TX', 'VA', 'WV', 'WY'],  # noqa
    '3': ['AL', 'AK', 'AZ', 'AR', 'CA', 'CO', 'CT', 'FL', 'GA', 'HI', 'ID', 'IL', 'IN', 'IA', 'KS', 'KY', 'LA', 'MD', 'MO', 'NV', 'NH', 'NY', 'NC', 'ND', 'OH', 'OK', 'OR', 'PA', 'SC', 'SD', 'UT', 'VT', 'WA', 'WI']  # noqa
}
