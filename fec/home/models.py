...
class ExtFileField(forms.EmbedForm):
    """
    Whitelists file types for uploads.
    """
    ...
    def clean(self, *args, **kwargs):
        ...
        if ext not in self.ext_whitelist:
            raise forms.ValidationError("Not allowed file type. Allowed types are: {0}".format(ext_whitelist))
