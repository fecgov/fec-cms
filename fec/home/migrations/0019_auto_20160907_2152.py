    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('option_blocks', wagtail.fields.StreamField((('option_blocks', wagtail.blocks.StructBlock((('title', wagtail.blocks.CharBlock(required=True)), ('intro', wagtail.blocks.RichTextBlock(blank=False, null=False, required=False)), ('button_text', wagtail.blocks.CharBlock(blank=False, null=False, required=True)), ('related_page', wagtail.blocks.PageChooserBlock())))),))),
                ('feed_intro', wagtail.fields.StreamField((('heading', wagtail.blocks.CharBlock(classname='full title')), ('paragraph', wagtail.blocks.RichTextBlock()), ('html', wagtail.blocks.RawHTMLBlock()), ('image', wagtail.images.blocks.ImageChooserBlock()), ('table', wagtail.contrib.table_block.blocks.TableBlock())), blank=True, null=True)),
                ('contact_intro', wagtail.fields.StreamField((('heading', wagtail.blocks.CharBlock(classname='full title')), ('paragraph', wagtail.blocks.RichTextBlock()), ('html', wagtail.blocks.RawHTMLBlock()), ('image', wagtail.images.blocks.ImageChooserBlock()), ('table', wagtail.contrib.table_block.blocks.TableBlock())), blank=True, null=True)),
            ],
            options={
                'abstract': False,
            },
