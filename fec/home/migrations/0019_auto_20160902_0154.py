# -*- coding: utf-8 -*-
# Generated by Django 1.9.9 on 2016-09-02 01:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('related_pages_sidebar', wagtail.wagtailcore.fields.StreamField((('related_pages', wagtail.wagtailcore.blocks.StructBlock((('title', wagtail.wagtailcore.blocks.CharBlock(required=True)), ('related_pages', wagtail.wagtailcore.blocks.PageChooserBlock(required=True))))),))),
                ('sections', wagtail.wagtailcore.fields.StreamField((('section', wagtail.wagtailcore.blocks.StructBlock((('title', wagtail.wagtailcore.blocks.CharBlock(required=True)), ('section_id', wagtail.wagtailcore.blocks.CharBlock(required=True)), ('style', wagtail.wagtailcore.blocks.ChoiceBlock(choices=[('checklist', 'Checklist'), ('bulleted', 'Bulleted list')], default='bulleted')), ('content', wagtail.wagtailcore.blocks.RichTextBlock())))),))),
            ],
            options={
                'abstract': False,
            },
