...
CORE_TABLE_OPTIONS = {'renderer': 'html'}
...
class CitationsBlock(blocks.StructBlock):
    ...
    content = blocks.RichTextBlock(
        help_text='Use Shift + Enter to add line breaks between citation and description'
    )
        ...
        [
            (
                ...
                blocks.RichTextBlock(
                    blank=False, null=False, required=False, icon='pilcrow'
                ),
            ),
            (
                'documents',
...
class CollectionBlock(blocks.StructBlock):
    CHECKLIST = 'check'
    BULLET = 'bullet'
    STYLE_CHOICES = [(CHECKLIST, 'Checklist'), (BULLET, 'Bulleted list')]
    title = blocks.CharBlock(required=True)
