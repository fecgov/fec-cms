...
def reaction_box(template, pid, **kwargs):
    ...
    # TO HARDCODE INTO TEMPLATE IMPORT AT TOP AND THEN LIKE THIS: {% reaction_box page.content_type.model page.id title='Do you like these buttons' location='home' name='home_buttons'%}
